  ...
  try {
    ...
    return Response.json({
      ...
      summary: {
        ...
        totalOrderCbm: results.summary.totalOrderCbm,
      },
      recommendations: results.recommendations.map((r) => ({
        ...
        containerCbmImpact: r.containerCbmImpact,
      ...
      containerPlans: results.containerPlans.map((cp) => ({
        ...
        totalCbm: cp.totalCbm,
        containerType: cp.containerType === "forty_gp" ? "40GP" : "40HQ",
        containerCount: cp.containerCount,
        fillPercentage: cp.fillPercentage,
        estimatedShippingCost: cp.estimatedShippingCost,
  ...
  try {
    ...
    return Response.json({
      ...
      recommendations: recs.map((r) => ({
        ...
        orderByDate: r.recommendedOrderByDate,
        projectedStockoutDate: r.projectedStockoutDate,
        containerCbmImpact: r.containerCbmImpact ? Number(r.containerCbmImpact) : null,
        explanation: r.explanation,
